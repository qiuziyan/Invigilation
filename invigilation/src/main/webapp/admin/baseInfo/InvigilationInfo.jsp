...
<script>
	$(document).ready(function(){
		...
		$("#btn_query").click(function(){
			$("#tb_exam").bootstrapTable("refresh");
		});
		$("#tb_exam").on('click','.modify',function(e){
		    var exam_id=$(this).attr("data-value");
		   	window.location.href = "invigilationModify.jsp?exam_id="+exam_id;
		});
	});
...
//            showToggle:true,                    //是否显示详细视图和列表视图的切换按钮
          ...
          },
          {
              ...
              title: '操作',
              formatter : function (value, row, index) {
              		return "<a data-value='"+row.exam_id+"' class='modify'>修改&nbsp&nbsp</a>";
